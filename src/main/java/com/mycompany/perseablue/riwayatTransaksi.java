            ...
            String query = "SELECT * FROM data_pesanan";
             ...
             while (Result.next()){
                 tb.addRow(new Object[]{
                     counter++,Result.getString(7), Result.getString(2), Result.getString(3),Result.getString(4), Result.getString(5),Result.getString(9), Result.getString(10), Result.getString(6),Result.getString(8)
                 });
             }
